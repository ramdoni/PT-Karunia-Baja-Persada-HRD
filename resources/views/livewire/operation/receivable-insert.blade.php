                ...
                <form id="basic-form" method="post" wire:submit.prevent="saveToJournal">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="px-0 form-group col-md-12" wire:ignore id="for-bootstrap-select">
                                <label>{{ __('Reference Type') }}</label>
                                <select class="form-control" wire:model="reference_type" data-container="#for-bootstrap-select">
                            ...
                            {{-- <div class="px-0 form-group col-md-12" wire:ignore id="for-bootstrap-select">
                                ...
                                <select class="form-control" id="policy_id" wire:model="policy_id" data-container="#for-bootstrap-select">
                                    <option value=""> --- Select --- </option>
                                    @foreach(\App\Models\Policy::orderBy('pemegang_polis')->get() as $i)
                                    <option value="{{ $i->id }}">{{$i->no_polis}} - {{$i->pemegang_polis}}</option>
                                    @endforeach
                                </select>
                            </div> --}}
                            <div class="row">
