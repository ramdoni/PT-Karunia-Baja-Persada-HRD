                            ...
                            <form wire:submit.prevent="autoSavePhoto" class="form_upload_photo">
                                <div class="media photo">
                                    <div class="media-left m-r-15">
                                        <img src="{{ $profile_photo_path }}" style="width:100px;"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <button type="button" class="btn btn-default-dark" id="btn-upload-photo"><i
                                                class="fa fa-upload"></i> Upload Photo</button>
                        ...
                        <div class="body">
                            <form wire:submit.prevent="saveBasicInformation">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <textarea class="form-control" wire:model="address" placeholder="Address"
