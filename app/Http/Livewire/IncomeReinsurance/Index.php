...
class Index extends Component
{
    ...
    public function downloadExcel()
    {
        ...
        $objPHPExcel->getProperties()->setCreator("Stalavista System")
                                    ...
                                    ->setSubject("Reinsurance Commision")
                                    ->setDescription("Reinsurance Premium.")
                                    ->setKeywords("office 2007 openxml php")
                                    ->setCategory("Income");

        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Reinsurance Commision');
        ...
        header('Content-Disposition: attachment;filename="income-reinsurance-' .date('d-M-Y') .'.xlsx"');
        ...
        },'income-reinsurance-' .date('d-M-Y') .'.xlsx');
    }
}