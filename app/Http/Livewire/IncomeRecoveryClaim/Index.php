...
class Index extends Component
{
    ...
    public function downloadExcel()
    {
        ...
        $objPHPExcel->getProperties()->setCreator("Stalavista System")
                                    ...
                                    ->setSubject("Recovery Claim")
                                    ->setDescription("Recovery Claim.")
                                    ->setKeywords("office 2007 openxml php")
                                    ->setCategory("Income");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Recovery Claim');
        ...
        header('Content-Disposition: attachment;filename="recovery-claim-' .date('d-M-Y') .'.xlsx"');
        ...
        },'recovery-claim-' .date('d-M-Y') .'.xlsx');
    }
}