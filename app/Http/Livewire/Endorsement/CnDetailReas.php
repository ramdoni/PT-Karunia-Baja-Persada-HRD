...
class CnDetailReas extends Component
{
    public $expense,$data,$no_voucher,$no_polis,$payment_amount,$premium_receivable,$is_submit=false,$is_readonly=false;
    public $reference_no,$to_bank_account_id,$from_bank_account_id,$payment_date,$bank_charges,$description,$type=1;
    public function render()
    {
        return view('livewire.endorsement.cn-detail-reas');
    }
    public function mount($id)
    {
        ...
        $this->payment_amount = $this->expense->payment_amount;
