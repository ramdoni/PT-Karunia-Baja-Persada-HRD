...
class CnInsertReas extends Component
{
    ...
    {
        return view('livewire.endorsement.cn-insert-reas');
    }
    ...
    public function save($type)
    {
        ...
        $data->reference_type = 'Endorsement CN Reas';
        ...
        \LogActivity::add("Endorsement CN Reas {$type} {$data->id}");
