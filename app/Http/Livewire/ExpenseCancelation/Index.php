...
class Index extends Component
{
    ...
    public function downloadExcel()
    {
        ...
        $objPHPExcel->getProperties()->setCreator("Stalavista System")
                                    ...
                                    ->setCategory("Expense");
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Cancelation');
        ...
        header('Content-Disposition: attachment;filename="cancelation-' .date('d-M-Y') .'.xlsx"');
