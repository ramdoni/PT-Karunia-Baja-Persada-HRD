...
class IncomeInsert extends Component
{
    public $no_voucher,$client,$recipient,$reference_type,$reference_no,$reference_date,$description,$nominal,$outstanding_balance,$tax_id,$payment_amount;
    public $tax_amount,$total_amount;
    public function render()
    {
        return view('livewire.operation.income-insert');
    }
