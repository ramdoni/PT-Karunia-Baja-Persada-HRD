...
class KonfirmasiOtp extends Component
{
    ...
    {
        return view('livewire.income-premium-receivable.konfirmasi-otp');
    }
    ...
    public function submit()
    {
        ...
        \LogActivity::add("Income - Premium Receivable Validate OTP");
        // check request 
        ...
        if($check_history >=10){
            ...
            if($cek_otp){
                ...
                $history->status = 1;
                $history->transaction_table = 'income - premium received';
                $history->save();
                $this->danger = 'OTP anda salah, silahkan di coba kembali.';
            }
        }
